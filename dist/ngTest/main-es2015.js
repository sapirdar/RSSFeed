...
/* harmony import */ var _services_rss_feeds_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./services/rss-feeds.service */ "./src/app/services/rss-feeds.service.ts");
/* harmony import */ var _components_main_main_component_ngfactory__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./components/main/main.component.ngfactory */ "./src/app/components/main/main.component.ngfactory.js");
...
/* harmony import */ var _main_component_scss_shim_ngstyle__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./main.component.scss.shim.ngstyle */ "./src/app/components/main/main.component.scss.shim.ngstyle.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
...
/* harmony import */ var _main_component__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./main.component */ "./src/app/components/main/main.component.ts");
/* harmony import */ var _services_rss_feeds_service__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ../../services/rss-feeds.service */ "./src/app/services/rss-feeds.service.ts");
/**
 * @fileoverview This file was generated by the Angular template compiler. Do not edit.
 *
 * @suppress {suspiciousCode,uselessCode,missingProperties,missingOverride,checkTypes}
...
class MainComponent {
        ...
        this.rssFeedsService.contentList$
            ...
            if (list && list.length > 0) {
                ...
                if (mapped.length > 0) {
                    ...
                    this.items = mapped.sort((a, b) => new Date(b.pubDate) - new Date(a.pubDate));
    ...
    search() {
        if (this.searchTerm.length > 1) {
            this.filteredItems = this.items.filter(i => i.content.indexOf(this.searchTerm) > -1 ||
...
/* harmony import */ var _sidebar_component__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! ./sidebar.component */ "./src/app/components/sidebar/sidebar.component.ts");
/* harmony import */ var _services_rss_feeds_service__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! ../../services/rss-feeds.service */ "./src/app/services/rss-feeds.service.ts");
/**
 * @fileoverview This file was generated by the Angular template compiler. Do not edit.
 *
 * @suppress {suspiciousCode,uselessCode,missingProperties,missingOverride,checkTypes}
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "RssFeedsService", function() { return RssFeedsService; });
/* harmony import */ var rxjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! rxjs */ "./node_modules/rxjs/_esm2015/index.js");
/* harmony import */ var _models_feed__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../models/feed */ "./src/app/models/feed.ts");
...
class RssFeedsService {
    ...
    addFeed(url, name) {
        ...
        if (this.feedList.filter(i => i.name === name).length === 0) {
            const feed = new _models_feed__WEBPACK_IMPORTED_MODULE_1__["Feed"](name, url);
            this._addItem(feed);
        }
    }
    removeFeed(url) {
    ...
    selectFeed(url) {
        const feed = this.feedList.find(i => i.url === url);
        if (!feed.selected) {
    ...
    getFeedContent(feed) {
        ...
        this.http.get(this.rssToJsonBaseUrl + feed.url).subscribe((res) => {
...
RssFeedsService.ngInjectableDef = _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵdefineInjectable"]({ factory: function RssFeedsService_Factory() { return new RssFeedsService(_angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵinject"](_angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpClient"]), _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵinject"](_local_storage_service__WEBPACK_IMPORTED_MODULE_5__["LocalStorageService"])); }, token: RssFeedsService, providedIn: "root" });
